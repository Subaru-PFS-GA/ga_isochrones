...
PACKAGE_NAME = 'pfs-isochrones'
PACKAGE_PPRINT_NAME = 'PFS Isochrones'
PACKAGE_GITHUB_URL = 'https://github.com/Subaru-PFS-GA/ga_isochrones'

# a-b-c => a/b/c
PACKAGE_FOLDER_PATH = PACKAGE_DIR + '/isochrones'
# a-b-c => pfs.ga.a.b.c
NAMESPACE_NAME = 'pfs.ga.isochrones'
...
for fn in glob.glob(PACKAGE_FOLDER_PATH + '/scripts/*.py'):
    with open(fn, encoding="utf-8") as f:
        if f.readline().startswith("#!/usr/bin/env python3"):
            ...
            cmd = cls.replace('_', '')
            console_scripts.append('pfs-isochrones-{} = {}.scripts.{}:main'.format(cmd, NAMESPACE_NAME, cls))
entry_points={
